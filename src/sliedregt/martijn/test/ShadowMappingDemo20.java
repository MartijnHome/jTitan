...
import static sliedregt.martijn.test.DemoUtils.createShader;
...
public class ShadowMappingDemo20 {
    ...
    private static Vector3f[] boxes = new
    Vector3f[]{
    ...
    void createShadowProgram() throws IOException {
        ...
        int vshader = createShader("/home/martijnvs/Bureaublad/JTitan workspace/src/Shader/deprecated/shadow/sm.vert", GL_VERTEX_SHADER);
        int fshader = createShader("/home/martijnvs/Bureaublad/JTitan workspace/src/Shader/deprecated/shadow/sm.frag", GL_FRAGMENT_SHADER);
    ...
    void createNormalProgram() throws IOException {
        ...
        int vshader = createShader("/home/martijnvs/Bureaublad/JTitan workspace/src/Shader/deprecated/shadow/sms.vert", GL_VERTEX_SHADER);
        int fshader = createShader("/home/martijnvs/Bureaublad/JTitan workspace/src/Shader/deprecated/shadow/sms.frag", GL_FRAGMENT_SHADER);
